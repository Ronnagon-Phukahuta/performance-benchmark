...
def write():
    ...
    print("Running write benchmark (sqlserver row_by_row)...")
    with measure("sqlserver_row_by_row_write", data_path="") as m:
        conn = _connect()
        cur = conn.cursor()
        cur.execute(
...
def read():
    ...
    with measure("sqlserver_row_by_row_read", data_path="") as m:
        conn = _connect()
...
def query():
    ...
    with measure("sqlserver_row_by_row_query", data_path="") as m:
        conn = _connect()
